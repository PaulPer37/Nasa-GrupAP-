...
SECRET_KEY = 'django-insecure-6**nas#$(uvv^yrtl*nf&q_fs)v=0f&yc-o6ko0ba)#aw%a6q+'
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'corsheaders',  # Para permitir que el mapa se comunique con la API
    'pollution',    # Nuestra app
